...
df_X_train = pd.read_csv("../simple_x_train.csv", header=None)
df_Y_train = pd.read_csv("../simple_y_train.csv", header=None)

df_X_test = pd.read_csv("../simple_x_test.csv", header=None)
df_Y_test = pd.read_csv("../simple_y_test.csv", header=None)
...
plt.savefig('plot_tnse_readmited_simple.png')